...
public class APP10 {
    ...
    static {
        memSize[0] = new int[]{512, 512, 512, 512, 512, 512, 512, 512, 512, 512};
//        memSize[1] = new int[]{1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024, 1024};
        memSize[1] = new int[]{2048, 2048, 2048, 2048, 2048, 2048, 2048, 2048, 2048, 2048};
...
////        memSize[2] = new int[]{10240, 10240, 10240, 10240, 10240, 10240, 10240, 10240, 10240, 10240};
        memSize[2] = new int[]{4096, 4096, 4096, 4096, 4096, 4096, 4096, 4096, 4096, 4096};
    }
...
//                Monitor.getCloudFlowLogs(APPName, "2025-06-16T06:23:53.032558400Z", "2025-06-16T06:38:33.735720Z", numOfMemSize + 1);
                ...
                double avgPerfCostModelDuration = Accuracy.getAvgDurationOfPerfCostModel(APP10.memConfig, APPName,numOfMemSize + 1);
                double avgPerfCostModelCost = Accuracy.getAvgCostOfPerfCostModel(APP10.memConfig, APPName,numOfMemSize + 1);
