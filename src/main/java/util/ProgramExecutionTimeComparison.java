...
public class ProgramExecutionTimeComparison {
    public static void WriteExecutionTimeToFile(String APPName, double[] executionTime, int iter) {
        try {
            ...
            row0.createCell(4).setCellValue("GAExecutionTimeOfBCPO(ms)");
            ...
            aRow.createCell(4).setCellValue(executionTime[8]);
            ...
            row0.createCell(4).setCellValue("GAExecutionTimeOfPCCO(ms)");
            ...
            aRow.createCell(4).setCellValue(executionTime[9]);
